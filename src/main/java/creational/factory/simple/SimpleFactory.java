...
public class SimpleFactory {
     ...
     */
    public static Calculator createProduct(String type) {
        if (type.equals(CreateConstant.ADD)){
            return new CalculatorAdd();
        } else if (type.equals(CreateConstant.SUBTRACT)) {
            return new CalculatorSubtract();
        } else if (type.equals(CreateConstant.MULTIPLY)) {
            return new CalculatorMultiply();
        } else if (type.equals(CreateConstant.DIVIDE)) {
